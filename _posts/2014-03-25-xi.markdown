...
Don't be confused by the title of this post - I will tell you about my experience in the development of xmpp client [xi][xi_github]. The first version of this client was written in Haskell in shortest time (for me, of cource), and this fact provides the second emotional part of title =)
...
* get an user roster and convert it to the internal representation (the `ContactList` type)
