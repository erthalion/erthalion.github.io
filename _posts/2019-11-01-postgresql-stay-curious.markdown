...
That was the last interesting example I have for today. I hope it was enough to
make you at least a bit interested in tracing and profiling your databases, and
look deeper into what happens inside and outside. Don't get me wrong, it's not
like when you run `perf` or something BPF based any issues will disappear
automagically, but you will definitely get more interesting information in your
hands.
