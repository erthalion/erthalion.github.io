...
It seems like there is no good IRC plugin for vim - I found none of them at least. But there is an brilliant geeky alternative - [ii][ii_site]. Here is a quote from its site:
